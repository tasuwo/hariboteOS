...
##EFLAGS：32bitのレジスタ．16bitのFLAGSの拡張．
...
##GDT(global (segment) descriptor table)：セグメントの設定テーブル
...
##IDT(interrupt descriptor table)：割り込み設定表
